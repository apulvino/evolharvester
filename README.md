...
## PLEASE NOTE:
Support for PAML suite model 'harvesters' is under development.

I hope to push a minor release with the first few baseml/codeml models soon.
...
If you use evolharvester in published work, please cite via (see DOI badge above):

> Anthony Pulvino. (2026). apulvino/evolharvester: PhlyHy (v0.5.0). Zenodo. https://doi.org/10.5281/zenodo.20091250

An Application Note describing evolharvester is in-preparation. Citation details will be updated upon acceptance.
